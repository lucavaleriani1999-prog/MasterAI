...
plt.bar(incasso_medio_categoria.index, incasso_medio_categoria, color="green", label="Incasso Medio per categoria")
plt.plot(quantità_media_categoria.index, quantità_media_categoria, color="orange", marker ="o", linestyle = "-", label="Quantità Media per categoria")
plt.xlabel("Incasso Medio per categoria")
