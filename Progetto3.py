...
df = pd.DataFrame({"clienti" : clienti, "destinazioni" : destinazioni, "prezzo" : prezzi, "giorno_della_partenza" : giorno_della_partenza, "durata_giorni" : durata_giorni, "incasso_euro" : incasso_euro})

df = pd.DataFrame(records, columns=["Cliente","Destinazione","Prezzo","Giorno_della_partenza","Durata","Incasso"])
